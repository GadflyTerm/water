    ...
    function(editableDirectiveFactory) {
        return editableDirectiveFactory({
            ...
            render: function() {
                ...
                var inputDatePicker = angular.element('<input type="text" class="form-control input-sm" data-ng-model="$parent.$data"/>');
                ...
                if (showCalendarButton === "true") {
                    var buttonDatePicker = angular.element('<button type="button" class="btn btn-default btn-sm"><i class="glyphicon glyphicon-calendar"></i></button>');
