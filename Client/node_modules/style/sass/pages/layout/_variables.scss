...
// Quick Sidebar
$quick-sidebar-bgc:#dddddd;
$quick-sidebar-width:                                                   350px !default;  // quick sidebar width. default: 245px;  
$quick-sidebar-tab-item-padding:										15px 15px;       // quick sidebar 
$quick-sidebar-tab-item-c:												#272B30;
$quick-sidebar-tab-item-active-c:										$quick-sidebar-bgc;
$quick-sidebar-toggler-fs:									16px;
$quick-sidebar-toggler-bgc: 									$quick-sidebar-bgc;
$quick-sidebar-toggler-c: 									$quick-sidebar-tab-item-c;
$quick-sidebar-toggler-radius: 								4px;
$quick-sidebar-toggler-sw: 									30px;
$quick-sidebar-toggler-sh: 									60px;
$quick-sidebar-toggler-position-t:							$quick-sidebar-toggler-sh;
$quick-sidebar-toggler-position-l:							$quick-sidebar-toggler-sw;
// Sidebar-r
$sidebar-r-w:		55px;
$sidebar-r-h:		660px;
$sidebar-r-mt:		-130px;
$sidebar-r-mr:		-90px;
$sidebar-r-pt:		$header-height;
...
// Z-index master list
$zindex-header-fixed:                                                   95 !default;
$zindex-header-static:                                                 95 !default;
$zindex-quick-sidebar:                                                  94 !default;
$zindex-quick-sidebar-full-height:										96 !default;
$zindex-sidebar-fixed:     												100 !default;
$zindex-footer-fixed:      												100 !default;
$zindex-sidebar-submenu:   												200 !default;
$zindex-go-to-top:   												    90 !default;
$zindex-sidebar-r:                                                  101 !default;
